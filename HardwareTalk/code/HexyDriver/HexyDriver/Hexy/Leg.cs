...
public class Leg
{
    ...
    private int _HipServoNumber;
    private int _KneeServoNumber;
    private int _AnkleServoNumber;

    private int _StepsPerSecond = 5;
    private int _Floor = 60; //this is the minimum level the legs will reach

    public Leg(ServotorController controller, string name, int hipServoNum, int kneeServoNum, int ankleServoNum)
    {
